...
def result():
    ...
    scaler_path=os.path.join(os.path.dirname('C:/Users/Gundeep Gulati/Downloads/Fuel-Efficiency-Prediction-using-ANN-main/Fuel-Efficiency-Prediction-using-ANN-main/models/'),'scaler.pkl')
    ...
    model=load_model(r"C:\Users\Gundeep Gulati\Downloads\Fuel-Efficiency-Prediction-using-ANN-main\Fuel-Efficiency-Prediction-using-ANN-main\models\model.h5")
